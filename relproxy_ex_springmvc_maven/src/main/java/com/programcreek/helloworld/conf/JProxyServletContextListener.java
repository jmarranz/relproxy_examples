package com.programcreek.helloworld.conf;
...
public class JProxyServletContextListener implements ServletContextListener
{
    ...
    {
        System.out.println("ServletContextListener contextInitialized springmvc maven");
	    ...
	    if (!configFile.exists())
	    	throw new RuntimeException("Missing /WEB-INF/conf_relproxy.properties needed to specify the project folder (absolute path) for RelProxy");
        ...
        JProxyInputSourceFileExcludedListener excludedListener = new JProxyInputSourceFileExcludedListener()
        {
            ...
            public boolean isExcluded(File file, File rootFolderOfSources)
            {
                ...
                {
                	return absPath.endsWith(File.separatorChar + "HelloWorldController.java") || 
                		   absPath.endsWith(File.separatorChar + "HelloWorldControllerDelegate.java");
                }                
            }
        };
